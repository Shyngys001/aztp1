...
language_ru.addEventListener("click", () => {
    ...
    his2.textContent = "Актауский завод трубной продукции специализируется на производстве и ремонте труб, предлагая экономичные решения, позволяющие минимизировать время простоя и защитить трубопроводы от коррозии и износа.";
    ...
    second_2.textContent = "Актауский завод трубной продукции труб специализируется на производстве и ремонте труб, предлагая экономичные решения, позволяющие минимизировать время простоя и защитить трубопроводы от коррозии и износа.";
    ...
    main_t2.textContent = "Актауский завод трубной продукции специализируется на производстве и ремонте труб, предлагая экономичные решения, позволяющие минимизировать время простоя и защитить трубопроводы от коррозии и износа.";
    ...
    main_t12.textContent = "осложненный различными видами коррозии, увеличил текущую наработку в 4 раза";
    main_t13.textContent = "Более 5000 тонн";
    main_t14.textContent = "Бурильные и насосно-компрессорные трубы с покрытием приносят дополнительную прибыль нефтедобывающим компаниям";
    ...
    p7.textContent = "Трубки с полиэтиленовой облицовкой EXPE (полиэтилен сверхвысоких температур)";
    p8.textContent = "EXPE Футеровка НКТ – это процесс нанесения на внутренние поверхности трубопроводов защитного покрытия, защищающего от механического, химического и других разрушительных воздействий контактирующих с ними сред. Внутренняя облицовка представляет собой высокомолекулярный материал на основе полиэтилена высокой плотности EXPE. Материал обладает хорошей эластичностью, высокой устойчивостью к механическому износу и влиянию АСПО и сероводорода.";
    ...
    p11.textContent = "По результатам испытаний межремонтный период скважин, оборудованных облицованными НКТ, увеличился в среднем в 3 раза.";
    ...
    p18.textContent = "Ремонт бывших в употреблении трубок с полиэтиленовой облицовкой EXPE (полиэтилен сверхвысоких температур).";
    ...
    contact2.innerHTML = "Республика Казахстан, Мангистауская область,<br>Промзона 4, участок 80/1";
...
language_en.addEventListener("click", () => {
    ...
    p5.textContent = "Ideal option upgrading oil production equipment";
    p6.textContent = "What is the EXPE?";
    p7.textContent = "Tubing with polyethylene EXPE (extra temperature polyethylene) lining";
    p8.textContent = "EXPE Lining of tubing pipes is the process of applying a protective coating to the inner surfaces of pipelines, which protects against mechanical, chemical and other destructive effects of the media in contact with them. The inner lining is a high molecular weight material based on high density polyethylene EXPE. The material has good elasticity, high resistance to mechanical wear and the influence of ARPS and hydrogen sulfide.";
    ...
    p18.textContent = "Repair of used tubing with polyethylene EXPE (extra temperature polyethylene) lining";
    ...
    contact2.innerHTML = "Republic of Kazakhstan, Mangistau region,<br>Industrial zone 4, plot 80/1";
...
language_kz.addEventListener("click", () => {
    ...
    his2.textContent = "Ақтау құбыр зауыты құбырларды өндіруге және жөндеуге маманданған, біз тоқтап қалуды барынша азайтатын және құбырларды коррозия мен тозудан қорғайтын үнемді шешімдерді ұсынамыз.";
    y2016_1.textContent = "2016";
    ...
    y2021_1.textContent = "2021";
    y2021_2.textContent = "Бұрғылау құбырында орындалған жұмыс көлемі 1000 тоннадан астам, ал құбыр ұзындығы 200 000 мың метрден астам. «Самара ғылыми-өндірістік орталығы» жауапкершілігі шектеулі серіктестігінің мәліметтері бойынша EXPE полиэтиленді төсемі бар құбырлардың зертханалық зерттеулері мен сынақтары TU 471010000 стандарттарына сәйкес келеді. Сол жылы AZTP Абу-Дабиде өткен ADIPEC көрмесіне қатысты.";
    ...
    p7.textContent = "Полиэтиленді EXPE (қосымша температуралы полиэтилен) төсемі бар құбырлар";
    ...
    p18.textContent = "Полиэтиленді EXPE (қосымша температуралы полиэтилен) төсемімен пайдаланылған құбырларды жөндеу";
    ...
    contact2.innerHTML = "Қазақстан Республикасы, Маңғыстау облысы,<br>4-өндірістік аймақ, 80/1 учаскесі";
